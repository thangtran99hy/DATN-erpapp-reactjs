...
function EquipmentTypeList(props) {
    ...
    return (
        <>
            ...
            >
                {t('equipment_type.label.add_new_equipment_type')}
            </Button>
            <Modal
                footer={null}
                title={action === ACTION_ADD ? t('equipment_type.label.add_new_equipment_type') : t('equipment_type.label.edit_equipment_type')}
            ...
            <CustomList
                apiNameList={'api/v1/equipmentType/list'}
