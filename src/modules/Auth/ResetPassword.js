...
const Login = (props) => {
    const {classes, width, match, history} = props;
    ...
    const onFinish = async (values) => {
        ...
        const res = await authApi.resetPassword(match.params.token, formData)
                    ...
                    <Col item xs={24} sm={24} md={12} lg={12} className={classes.right}>
                        <div className={classes.login}>
                            <div className="loginText">
                                {t('login.label.reset_passwordText')}
                            </div>
                            <Form
                                name="normal_login"
                            ...
                            >
                                ...
                                >
                                    <Input.Password className="inputLogin" placeholder={t('login.field.password')}/>
                                </Form.Item>
                                <Form.Item>
...
export default compose(withStyles(styles), withWidth(), withRouter)(Login);
